...
CAND_MSG_ID = 237           # test message in source (media)
TARGET_TOPIC_ID = 6404      # topic.id (used for send_file)
TOP_MSG_ID = 6414           # top_message (used for InputReplyToMessage)
PLACEHOLDER_MSG_ID = 6414   # an existing message id in the target topic
